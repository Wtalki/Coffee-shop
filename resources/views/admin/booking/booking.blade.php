                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="list">
                                ...
                                <td class=" align-content-center ">{{$b->date}}</td>
                                <td class=" align-content-center ">{{$b->time}}</td>
                                <td class=" align-content-center ">{{$b->phone}}</td>
                                <td class=" align-content-center ">{{$b->description}}</td>
...
<script>
    $(function(){
        ...
        $.ajax({
        type: 'get',
        url: 'http://127.0.0.1:8000/admin/booking/status',
        data: $data,
        dataType: 'json',
        })
        })
